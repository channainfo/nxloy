...
-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('CREATE', 'READ', 'UPDATE', 'DELETE', 'LOGIN', 'LOGOUT', 'GRANT_PERMISSION', 'REVOKE_PERMISSION', 'EXPORT_DATA', 'IMPORT_DATA');

-- CreateEnum
CREATE TYPE "Status" AS ENUM ('ACTIVE', 'INACTIVE', 'SUSPENDED', 'ARCHIVED');

-- CreateEnum
CREATE TYPE "Currency" AS ENUM ('USD', 'EUR', 'GBP', 'CAD', 'AUD', 'SGD', 'THB', 'VND', 'IDR', 'MYR', 'PHP');

-- CreateEnum
CREATE TYPE "Language" AS ENUM ('EN', 'TH', 'VI', 'ID', 'MS', 'ZH', 'JA', 'KO');
